...
$packageName = 'hugo'
$installerType = 'exe'
$url = 'https://github.com/spf13/hugo/releases/download/v0.16/hugo_0.16_windows-32bit.zip' # download url
$url64 = 'https://github.com/spf13/hugo/releases/download/v0.16/hugo_0.16_windows-64bit.zip' # 64bit URL here or remove - if installer decides, then use $url
